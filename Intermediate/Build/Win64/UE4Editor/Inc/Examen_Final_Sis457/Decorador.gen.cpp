...
#include "Examen_Final_Sis457/Decorador.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	EXAMEN_FINAL_SIS457_API UClass* Z_Construct_UClass_ADecorador_NoRegister();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ADecorador_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ADecorador_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UEnemy_NoRegister, (int32)VTABLE_OFFSET(ADecorador, IEnemy), false },
		};
	...
	IMPLEMENT_CLASS(ADecorador, 407579268);
	template<> EXAMEN_FINAL_SIS457_API UClass* StaticClass<ADecorador>()
	{
		return ADecorador::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ADecorador(Z_Construct_UClass_ADecorador, &ADecorador::StaticClass, TEXT("/Script/Examen_Final_Sis457"), TEXT("ADecorador"), false, nullptr, nullptr, nullptr);
